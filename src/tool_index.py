...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "hermes_agent": "Gateway messaging on vm-hermes: list Hermes profiles, one-shot chat to hermes-bert/hermes-amy/etc., or hermes send to Telegram/Discord. Prefer hermes-messaging MCP when connected.",
...
class ToolIndex:
    ...
    _KEYWORD_HINTS = {
        ...
        frozenset({"kanban", "hermes", "morpheus", "vm-hermes", "kanban board", "kanban card",
            ...
            {"hermes_ssh", "hermes_kanban", "hermes_agent", "bash"},
