...
class MemoryProvider(ABC):
    """Base contract for Pandamonium memory providers.
...
class NativeMemoryProvider(MemoryProvider):
    """Provider adapter for Pandamonium' built-in memory manager and vector store."""

    provider_id = "native"
    display_name = "Pandamonium native memory"
