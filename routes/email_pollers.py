                        ...
                        if jm:
                            ...
                            if urgency in ("critical", "high"):
                                try:
                                    ...
                                    # Deep-link to open the original email in Pandamonium (if public URL is configured).
                                    ...
                                    alert_body = (
                                        ...
                                        f"Reason: {reason}\n\n"
                                        + (f"Open in Pandamonium: {open_url}\n\n" if open_url else "")
                                        + f"---\n"
                                        f"From: {sender}\n"
                                        f"Subject: {subject}\n"
                                        f"Date: {msg.get('Date','')}\n\n"
                                    ...
                                    # HTML alternative with a clickable "Open in Pandamonium" button
                                    import html as _h
    ...
    try:
        ...
        for r in rows:
            ...
            try:
                ...
                outer["X-Pandamonium-Origin"] = "pandamonium-ui"
                outer["X-Pandamonium-Kind"] = re.sub(r"[^A-Za-z0-9_.-]", "-", odysseus_kind or "scheduled")[:64]
                outer["X-Pandamonium-Ref"] = sid
                if r[6]:
