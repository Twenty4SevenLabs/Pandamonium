...
RENDER_GID=""
VIDEO_GID=""
TEST_IMAGE="${PANDAMONIUM_AMD_TEST_IMAGE:-${ODYSSEUS_AMD_TEST_IMAGE:-alpine:3.20}}"
...
Environment:
  PANDAMONIUM_AMD_TEST_IMAGE  Docker image for the passthrough smoke
                              (legacy: ODYSSEUS_AMD_TEST_IMAGE; default: alpine:3.20)
USAGE
}
