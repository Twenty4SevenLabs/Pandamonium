...
Pandamonium email accounts currently use IMAP and SMTP with username/password
...
This is expected. Pandamonium does not support Microsoft OAuth or Graph Mail yet,
