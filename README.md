...
This labs247 copy uses GitLab origin only
(`ssh://git@192.168.1.93:2222/labs247/pandamonium.git`). Do not add a GitHub
remote. Later upstream updates go through `/safe-repo-ingest`, not `git pull`
from GitHub.
